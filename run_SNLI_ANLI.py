...
def main():
    ...
    if args.dataset.endswith('.json') or args.dataset.endswith('.jsonl'):
        ...
        dataset_snli = datasets.load_dataset('snli')
        dataset_anli = datasets.load_dataset('anli')
    ...
    if training_args.do_train:
        train_dataset = datasets.concatenate_datasets([dataset_snli['train'], dataset_anli['train_r1'], dataset_anli['train_r2'], dataset_anli['train_r3']])
        #train_dataset = dataset['train']
        print("len traindata merged:",len(train_dataset))
