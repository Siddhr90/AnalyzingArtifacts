...
def main():
    ...
    if args.dataset.endswith('.json') or args.dataset.endswith('.jsonl'):
        ...
        default_datasets = {'qa': ('squad',), 'anli': ('anli','r3_dev')}
        ...
        dataset = datasets.load_dataset('anli')         # zz_SID
    ...
    if training_args.do_eval:
        ...
        #eval_dataset = dataset['dev_r2']
        #eval_dataset = dataset['dev_r3']        ## zz_SID ANLI data
        #eval_dataset = dataset['test_r1']
        #eval_dataset = dataset['test_r2']
