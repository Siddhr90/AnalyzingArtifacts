...
# Concatenate the training sets of all rounds
train_dataset = datasets.concatenate_datasets([anli_dataset['train_r1'], anli_dataset['train_r2'], anli_dataset['train_r3']])
# For evaluation, you can choose the round you want to evaluate on, for example, R3
#eval_dataset = anli_r3['validation']  # or 'test', based on your requirement

first_five_examples = train_dataset[:5]

first_five_examples = train_dataset.select(range(5))



# Now you can iterate over these examples
for example in first_five_examples:
    print(example)

print(len(train_dataset))
print(len(anli_dataset['train_r1']))
print(len(anli_dataset['train_r2']))
print(len(anli_dataset['train_r3']))
